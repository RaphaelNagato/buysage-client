...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe(
      'pk_test_51JcDjhDEvVeylPOtFJJSQyT7ax5SmMH8EoJnLci2JbSemH1nu2LhwwvL5uxbSC9xfkLGyzcu7amkeEvDVfaiG3CK00r26Ten9w'
    );
  ...
  async confirmPaymentWithStripe(basket: IBasket | null) {
  ...
  async createOrder(basket: IBasket | null) {
